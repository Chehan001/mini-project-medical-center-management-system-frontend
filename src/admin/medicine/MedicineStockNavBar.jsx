...
const MedicineStockNavBar = () => {
  ...
  const navItems = [
    { text: "Stock Details", path: "/admin/medicine/show" },
    { text: "Add Medicine", path: "/admin/medicine/add" },
    { text: "Distribution", path: "/admin/medicine/distribution" },
  ];
...
export default MedicineStockNavBar;
