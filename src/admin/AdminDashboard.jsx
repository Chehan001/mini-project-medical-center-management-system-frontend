    ...
    <Grid container spacing={3}>
      <Grid item xs={12} md={6}>
        <Paper sx={{ p: 2 }}>
          ...
          <Button component={Link} to="/admin/users" variant="contained" sx={{ mt: 2 }}>Go to Users</Button>
        </Paper>
      </Grid>
      <Grid item xs={12} md={6}>
        <Paper sx={{ p: 2 }}>
          ...
          <Button component={Link} to="/admin/home-content" variant="contained" sx={{ mt: 2 }}>Go to Home Content</Button>
        </Paper>
      </Grid>
    </Grid>
  </Box>
